...
export class BoardComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.boardService
      ...
      .subscribe((res: HttpResponse<IBoard[]>) => this.paginateBoards(res.body, res.headers));
  }
  ...
  registerChangeInBoards(): void {
    this.eventSubscriber = this.eventManager.subscribe('boardListModification', () => this.reset());
  }
